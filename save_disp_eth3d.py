...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--left_imgs', help="path to all first (left) frames", default="~/Workspace/Researches/Datasets/ETH3D/two_view_*/*/im0.png")
    parser.add_argument('-r', '--right_imgs', help="path to all second (right) frames", default="~/Workspace/Researches/Datasets/ETH3D/two_view_*/*/im1.png")
